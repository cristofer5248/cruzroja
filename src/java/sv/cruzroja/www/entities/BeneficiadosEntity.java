...
//    @NamedQuery(name = "BeneficiadosEntity.findByIdDateRange", query = "SELECT b FROM BeneficiadosEntity b where CAST(b.idproyecto.lugarproyectoPadre.fechainicio as Date)>= :fecha1 AND CAST (b.idproyecto.lugarproyectoPadre.fechafinal as Date)<= :fecha2"),
    @NamedQuery(name = "BeneficiadosEntity.findByIdDateRange", query = "SELECT b FROM BeneficiadosEntity b where CAST(b.fecha as Date)>= :fecha1 AND CAST (b.fecha as Date)<= :fecha2"),
